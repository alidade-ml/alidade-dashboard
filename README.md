...
The dashboard for [alidade](https://github.com/alidade-ml/alidade). A
...
- `alidade_dashboard-X.Y.Z-py3-none-any.whl` — Python wheel
  containing the static frontend bundle (no Python code; just a
  bundled directory of HTML/JS/CSS)
- `SHA256SUMS` — checksums for both

[`alidade admin dashboard install`](https://github.com/alidade-ml/alidade/blob/main/docs/Installation.md#17-install-the-dashboard-v150)
...
The alidade repo's `alidade admin dashboard upgrade` resolves the
